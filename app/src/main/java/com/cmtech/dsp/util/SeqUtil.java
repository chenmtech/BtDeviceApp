...
public class SeqUtil {
	 ...
	 * @since JDK 1.6
	 */
	public static <T> ISeq<T> add(final ISeq<T> seq1, ISeq<T> seq2) {
	 ...
	 * @since JDK 1.6
	 */
	public static <T> ISeq<T> subtract(final ISeq<T> seq1, ISeq<T> seq2) {
		return process(seq1, seq2, new IBiOperator<T>() {
			@Override
			public T operator(T op1, T op2) {
	 ...
	 * @since JDK 1.6
	 */
	public static <T> ISeq<T> multiple(final ISeq<T> seq1, ISeq<T> seq2) {
		return process(seq1, seq2, new IBiOperator<T>() {
			@Override
			public T operator(T op1, T op2) {
	 ...
	 * @since JDK 1.6
	 */
	public static <T> ISeq<T> divide(final ISeq<T> seq1, ISeq<T> seq2) {
		return process(seq1, seq2, new IBiOperator<T>() {
			@Override
			public T operator(T op1, T op2) {
